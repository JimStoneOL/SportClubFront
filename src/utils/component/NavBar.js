...
export const Navbar = () => {
  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <Link to={'/'} class="flex items-center">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Спортивные товары</span>
    </Link>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      ...
      { auth.isAuthenticated && auth.role==='ROLE_USER' && <li>
        ...
        { auth.isAuthenticated && auth.role==='ROLE_ADMIN' && <li>
          <NavLink to={'/basket'} class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-700 md:p-0 dark:text-white md:dark:hover:text-pink-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Товары</NavLink>
        </li>}
      ...
      {auth.isAuthenticated ?  <li>
         ...
         <li>
          <NavLink to={'/login'} class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-pink-700 md:p-0 dark:text-white md:dark:hover:text-pink-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Войти</NavLink>
      </li>
        }
      </ul>
    </div>
